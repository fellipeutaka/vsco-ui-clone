import { Container, ContentContainer, ContentTitle, Title } from "./styles";
...
export default function PillarsSection() {
  return (
    <Container>
      <Title>Creative tools, inspiration, and a place for you to be you.</Title>
      <ContentContainer>
        <div>
          <ContentTitle>
            <SettingsIcon />
          ...
          <p>Photo and video tools for creators, by creators.</p>
        </div>
        <div>
          <ContentTitle>
            <DiscoverIcon />
          ...
          <p>A place to discover new perspectives and share your own.</p>
        </div>
        <div>
          <ContentTitle>
            <ConnectIcon />
          ...
          <p>Freedom from follower counts, comments, and ads.</p>
        </div>
      </ContentContainer>
    </Container>
  );
